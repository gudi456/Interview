...
<div class="container">
    ...
    <form id="editCustomerForm">
        @csrf
        @method('PUT')
        <input type="hidden" name="customer_id" id="customer_id" data-customer-id="{{ $customer->id }}">
        <div class="form-group row">
            <label for="firstname" class="col-md-4 col-form-label text-md-right">{{ __('First Name') }}</label>

            <div class="col-md-6">
                <input id="firstname" type="text" class="form-control" name="firstname" value="{{ $customer->firstname }}" autocomplete="firstname" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="contact_number" type="text" class="form-control" name="contact_number" value="{{ $customer->contact_number }}" autocomplete="lastname">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="postcode" type="text" class="form-control" name="postcode" value="{{ $customer->postcode }}" autocomplete="lastname">
        ...
        <div class="form-group row">
            ...
            <select id="city" name="city" class="form-control">
                ...
                @if($customer->city)
                    @foreach($customer->city->state->cities as $city)
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="hobby1" name="hobbies[]" value="Reading" {{in_array('Reading', explode(',',$customer->hobbies)) ? 'checked' : ''}}>
                    <label class="form-check-label" for="hobby1">
                        Reading
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="hobby2" name="hobbies[]" value="Sports" {{in_array('Sports', explode(',',$customer->hobbies)) ? 'checked' : ''}}>
                    <label class="form-check-label" for="hobby2">
                        Sports
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="hobby3" name="hobbies[]" value="Sports" {{in_array('Traveling', explode(',',$customer->hobbies)) ? 'checked' : ''}}>
...
$('#editCustomerForm').validate({
    ...
    submitHandler: function(form) {
        var customerId = $('#customer_id').data('customer-id');
